...
class SizeUpGenerator : public MoveGenerator
{
 ...
 private:
  ...
  sta::LibertyCell* selectReplacement(const Target& target,
                                      sta::LibertyPort* in_port,
  ...
  std::vector<sta::LibertyCell*> selectReplacements(
      const Target& target,
      sta::LibertyPort* in_port,
      sta::LibertyPort* drvr_port,
      float load_cap,
  ...
  sta::LibertyCell* upsizeCell(const Target& target,
                               sta::LibertyPort* in_port,
                               sta::LibertyPort* drvr_port,
                               float load_cap,
                               float prev_drive,
                               const sta::Scene* scene,
                               const sta::MinMax* min_max) const;
  std::vector<sta::LibertyCell*> upsizeCells(const Target& target,
                                             sta::LibertyPort* in_port,
                                             sta::LibertyPort* drvr_port,
                                             float load_cap,
                                             float prev_drive,
