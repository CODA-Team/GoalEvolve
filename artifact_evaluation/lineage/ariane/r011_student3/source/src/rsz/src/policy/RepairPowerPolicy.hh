...
private:
  ...
  struct Candidate {
    ...
    double score{0.0};
    bool stability_sampled_tiebreak{false};
  };
  ...
  void markStabilitySampledTies(std::vector<Candidate> &candidates) const;
  bool stabilitySampledPreferred(const Candidate &lhs,
