...
public:
  // === Construction =========================================================
  explicit VtSwapGenerator(
      const GeneratorContext &context,
      std::unordered_set<sta::Instance *> *not_swappable = nullptr);
  ...
  generate(const Target &target) override;
...
private:
  ...
  bool selectBestCell(const Target &target, sta::Pin *&drvr_pin,
                      sta::Instance *&inst, sta::LibertyCell *&curr_cell,
                      sta::LibertyCell *&best_cell) const;
  bool selectPathBestCell(const Target &target, sta::Pin *&drvr_pin,
                          sta::Instance *&inst, sta::LibertyCell *&curr_cell,
                          sta::LibertyCell *&best_cell) const;
  bool selectInstanceBestCell(const Target &target, sta::Instance *&inst,
                              sta::LibertyCell *&curr_cell,
                              sta::LibertyCell *&best_cell) const;
  bool resolvePathCurrentCell(sta::Pin *drvr_pin,
                              sta::LibertyCell *&curr_cell) const;
  bool selectBestEquivCell(const Target &target, sta::LibertyCell *curr_cell,
                           sta::LibertyCell *&best_cell) const;
  bool selectPowerEquivCell(sta::LibertyCell *curr_cell,
                            sta::LibertyCell *&best_cell) const;
