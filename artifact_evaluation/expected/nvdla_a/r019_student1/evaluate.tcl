...
read_def [goalevolve_path {__BENCHMARK_ROOT__/benchmarks/nvdla_a/nvdla_a.def.gz}]
read_verilog [goalevolve_path {__BENCHMARK_ROOT__/benchmarks/nvdla_a/nvdla_a.v}]
read_sdc [goalevolve_path {__BENCHMARK_ROOT__/benchmarks/nvdla_a/nvdla_a.sdc}]
...
write_def [goalevolve_path {__OUTPUT_ROOT__/nvdla_a.def}]
write_verilog [goalevolve_path {__OUTPUT_ROOT__/nvdla_a.v}]
