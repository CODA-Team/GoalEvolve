...
read_def [goalevolve_path {__BENCHMARK_ROOT__/benchmarks/nvdla_c/nvdla_c.def.gz}]
read_verilog [goalevolve_path {__BENCHMARK_ROOT__/benchmarks/nvdla_c/nvdla_c.v}]
read_sdc [goalevolve_path {__BENCHMARK_ROOT__/benchmarks/nvdla_c/nvdla_c.sdc}]
...
write_def [goalevolve_path {__OUTPUT_ROOT__/nvdla_c.def}]
write_verilog [goalevolve_path {__OUTPUT_ROOT__/nvdla_c.v}]
