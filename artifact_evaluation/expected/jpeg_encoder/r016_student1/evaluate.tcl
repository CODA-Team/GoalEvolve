...
read_def [goalevolve_path {__BENCHMARK_ROOT__/benchmarks/jpeg_encoder/jpeg_encoder.def}]
read_verilog [goalevolve_path {__BENCHMARK_ROOT__/benchmarks/jpeg_encoder/jpeg_encoder.v}]
read_sdc [goalevolve_path {__BENCHMARK_ROOT__/benchmarks/jpeg_encoder/jpeg_encoder.sdc}]
...
report_power
write_verilog [goalevolve_path {__OUTPUT_ROOT__/post_repair_timing_pre_mid_power.v}]
write_db [goalevolve_path {__OUTPUT_ROOT__/post_repair_timing_pre_mid_power.odb}]
...
report_power
write_verilog [goalevolve_path {__OUTPUT_ROOT__/post_repair_power_mid.v}]
write_db [goalevolve_path {__OUTPUT_ROOT__/post_repair_power_mid.odb}]
...
write_def [goalevolve_path {__OUTPUT_ROOT__/jpeg_encoder.def}]
write_verilog [goalevolve_path {__OUTPUT_ROOT__/jpeg_encoder.v}]
