...
read_def [goalevolve_path {__BENCHMARK_ROOT__/benchmarks/nvdla_p/nvdla_p.def.gz}]
read_verilog [goalevolve_path {__BENCHMARK_ROOT__/benchmarks/nvdla_p/nvdla_p.v}]
read_sdc [goalevolve_path {__BENCHMARK_ROOT__/benchmarks/nvdla_p/nvdla_p.sdc}]
...
file mkdir [goalevolve_path {__OUTPUT_ROOT__/rmp_area_restructure}]
...
restructure -liberty_file [goalevolve_path {__OUTPUT_ROOT__/rmp_standard_cells.lib}] -target area -slack_threshold 0 -depth_threshold 16 -work_dir [goalevolve_path {__OUTPUT_ROOT__/rmp_area_restructure}]
...
report_power
write_verilog [goalevolve_path {__OUTPUT_ROOT__/post_rmp_area_restructure.v}]
write_db [goalevolve_path {__OUTPUT_ROOT__/post_rmp_area_restructure.odb}]
...
write_def [goalevolve_path {__OUTPUT_ROOT__/nvdla_p.def}]
write_verilog [goalevolve_path {__OUTPUT_ROOT__/nvdla_p.v}]
