...
ae2-preflight:
	...
	@source "$(PROJECT_ROOT)/outputs/toolchain/activate.sh"; PYTHONPATH=. "$$GOALEVOLVE_CONDA_PREFIX/bin/python" artifact_evaluation/ae2/run_ae2.py preflight --artifact aes_cipher_top_student_code --verbose
